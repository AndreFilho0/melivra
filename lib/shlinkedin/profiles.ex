  ...
  def send_email_invite({:ok, %Invite{profile_id: profile_id, email: email} = invite}) do
    ...
    <html>
      ...
      <body>
        <div class="container">
          <div class="header">
            <h1>Convite para a Comunidade MeLivra</h1>
          </div>
          <div class="content">
            <p>Olá!</p>
            <p>Você foi convidado por #{from.persona_name} para se juntar à nossa comunidade no melivra.com!</p>
            <p>MeLivra é uma plataforma divertida e séria para alunos, professores e membros da comunidade acadêmica se conectarem, trocarem ideias e muito mais.</p>
            <p>Para aceitar o convite e se inscrever, basta clicar no link abaixo:</p>
            <p><a href="https://www.melivra.com/join?ref=#{from.slug}">Clique aqui para se juntar ao MeLivra</a></p>
          </div>
          <div class="footer">
    ...
    Shlinkedin.Email.new_email(
      email,
      "#{from.persona_name} te convidou para se juntar ao MeLivra!",
      body
    )
