defmodule ShlinkedinWeb.ProfileLive.FollowButton do
    ...
    if first_ever_shlink?(profile) do
      ...
      award_type =
        Awards.get_or_create_award_type(%{
          ...
          "emoji" => "🤝",
          "description" => " Networking Virginity!"
        })
  ...
  def render(assigns) do
    ...
    <% _ ->  %>
    <button type="button" phx-click="unfollow" data-confirm="Tem certeza ?" phx-target="<%= @myself %>" phx-value-id="<%= @to_profile.id %>"
        ...
        <div x-show="open" x-transition:enter="ease-out duration-300"
            ...
            <div @click.away="open = false" @keydown.escape.window="open = false"
                ...
                <div class="flex items-center justify-between p-4 rounded-t bg-gray-100">
                    <h5 class="mb-0 text-base font-semibold bg-gray-100 font-windows">Parabéns 🥳!</h5>
                ...
                <div class="p-5 rounded-b-lg font-windows bg-white">
                    ...
                    <p class="">Você acabou de perder sua virgindade na Rede</p>


                    <p class="italic"> Me Livra</p>

                    <div class="text-center animate-fadeDown">
                        <p class="text-8xl text-center">🤝</p>
                        <p>Continue Assim <%= live_redirect "Caixa de troféus", to: Routes.profile_show_path(@socket, :show, @profile.slug), class: "text-blue-500 underline hover:text-blue-600" %></p>
