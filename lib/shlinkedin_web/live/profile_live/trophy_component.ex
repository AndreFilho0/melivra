defmodule ShlinkedinWeb.ProfileLive.TrophyComponent do
  ...
  def render(assigns) do
    ...
    <div class="bg-white rounded-lg shadow">
        <div class="p-6">
            <h2 id="who-to-follow-heading" class={"font-bold text-gray-900 #{@size}"}>Caixa de troféus</h2>
          ...
          <div class="text-center">
              <p class="font-semibold text-gray-600  my-4">Nada ainda 😔</p>
              <p class="text-xs text-gray-600 italic">Em algum momento você também vai ganhar</p>
