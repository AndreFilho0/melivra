  ...
  def render(assigns) do
    ...
    <div class="flex items-center">
        ...
        <div class="ml-3 sm:ml-4 relative w-11/12 cursor-pointer text-gray-500 truncate overflow-hidden">
            ...
            <%= if @post.profile_update == true, do: "Foto Atualizada ", else: @post.profile.persona_title %>
        </span>
          ...
          <% group -> %>
            ...
            <%= Timex.from_now(@post.inserted_at) %> •
             <%= live_redirect Shlinkedin.Levels.profile_level(@socket, @post.profile), to: Routes.profile_show_path(@socket, :show, @post.profile.slug), class: "text-xs text-gray-500" %>
